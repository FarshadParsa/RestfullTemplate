...
namespace PPC.Response.DTOs
{
    public class TestPlanAssignViewModelDTO
    {
        ...
        [JsonProperty("TestPlanAssign_LastNodeID")]
        public int? TestPlanAssign_LastNodeID { get; set; }
        [JsonProperty("TestPlanAssign_ParentID")]
        public int? TestPlanAssign_ParentID { get; set; }
